...
import { SECTION_IDS } from './nav.constant'
import {
  IBenefit,
  ICollabApp,
  ICollabContent,
...
export const navigation = [
  {
    id: '0',
    title: 'Features',
    url: `#${SECTION_IDS.FEATURES}`
  },
  {
    id: '1',
    title: 'Pricing',
    url: `#${SECTION_IDS.PRICING}`
  },
  {
    id: '2',
    title: 'How to use',
    url: `#${SECTION_IDS.HOW_TO_USE}`
  },
  {
    id: '3',
    title: 'Roadmap',
    url: `#${SECTION_IDS.ROADMAP}`
  },
  {
    id: '4',
    title: 'New account',
    url: `#${SECTION_IDS.SIGNUP}`,
    onlyMobile: true
  },
  {
    id: '5',
    title: 'Sign in',
    url: `#${SECTION_IDS.LOGIN}`,
    onlyMobile: true
  }
]
...
export const collabApps: ICollabApp[] = [
  {
    id: '0',
    title: 'Figma',
    icon: figma,
